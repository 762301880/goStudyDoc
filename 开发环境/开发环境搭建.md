...
| go-语言安装包下载地址 | [link](https://golang.google.cn/dl/)  [推荐稳定版](https://go.p2hp.com/go.dev/dl/) |
| go安装包镜像站        | [阿里云](https://mirrors.aliyun.com/golang/) [南京大学](https://mirrors.nju.edu.cn/golang/)  [华中科大](https://mirrors.hust.edu.cn/golang/) |

# 安装

## windows安装

### **下载安装包**(推荐安装最新版   go1.22.*版本)
...
>
> [下载稳定版-版本太低不推荐](https://go.p2hp.com/dl/go1.17.3.windows-amd64.zip)

![image-20220620154954305](https://gitee.com/yao_liu_yang/blogImages/raw/master/blogImages/image-20220620154954305.png)
...
![image-20220620155719041](https://gitee.com/yao_liu_yang/blogImages/raw/master/blogImages/image-20220620155719041.png)
...
# 切换为七牛 goproxy.cn（完美支持sumdb转发，国内最稳）
...
```go
//新增一行 版本可以通过go version命令确认自己的版本

const TheVersion = `go1.20.14`
```

重新选择**到项目目录即可**

![image-20220620154707417](https://gitee.com/yao_liu_yang/blogImages/raw/master/blogImages/image-20220620154707417.png)
...
![image-20230506145151017](https://gitee.com/yao_liu_yang/blogImages/raw/master/blogImages/image-20230506145151017.png)

**下载后解压**

> D:\Program Files\mingw64

![image-20230506150005183](https://gitee.com/yao_liu_yang/blogImages/raw/master/blogImages/image-20230506150005183.png)

**配置环境变量**

![image-20230506150042127](https://gitee.com/yao_liu_yang/blogImages/raw/master/blogImages/image-20230506150042127.png)
...
## 如果报错 go报错 Unresolved reference 'Println' (重要)

#### GoLand

`File → Invalidate Caches...` → 勾选所有 → 重启
...
以后 GoLand 改了 `go.mod`、新增包、换模块，**直接清缓存重启**，比瞎改代码省事多了😎
